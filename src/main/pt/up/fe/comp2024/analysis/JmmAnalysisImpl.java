...
import pt.up.fe.comp2024.analysis.passes.TypeAnalysis;
import pt.up.fe.comp2024.analysis.passes.UndeclaredVariable;
import pt.up.fe.comp2024.analysis.passes.VarDeclarations;
...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    public JmmAnalysisImpl() {
        ...
        this.analysisPasses.add(new UndeclaredVariable());
        this.analysisPasses.add(new VarDeclarations());
        this.analysisPasses.add(new TypeAnalysis());
